  ...
  try {
    ...
    if (hasKeyword) {
      ...
      const crisisReading = deep
        ? `I hear your pain, and it's real. Right now feels overwhelming, but this moment is not your forever. You have inherent worth that exists independent of anyone else's love or recognition.\n\nWhat you're feeling is a response to real hurt and real circumstances. Family dynamics can wound us deeply, especially when love feels unequally distributed. But your worth is not determined by how others treat you. You are valuable simply because you exist.\n\nHere are three things you can do today:\n1) Reach out to one person you trust, even just to say "I'm struggling" - vulnerability is strength, not weakness\n2) Take one small step toward self-care - a walk outside, a nourishing meal, rest, or anything that feels gentle\n3) Contact a crisis counselor who can provide immediate, compassionate support without judgment\n\nResources available 24/7:\nNational Suicide Prevention Lifeline (US): 988\nCrisis Text Line: Text HOME to 741741\nInternational: findahelpline.com\n\nThis pain you feel right now - it can shift. Healing is possible. Connection is possible. Joy is possible, even if it feels impossibly far away right now. One year from now, you will be grateful you reached out today. Your story is still being written, and you deserve to see how it unfolds.`
