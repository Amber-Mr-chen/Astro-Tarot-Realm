  ...
  try {
    ...
    if (hasKeyword) {
      ...
      const crisisReading = deep
        ? `I hear your pain, and it's real. Right now feels overwhelming, but this moment is not your forever. You have inherent worth that exists independent of anyone else's love or recognition.\n\nHere are three things you can do today:\n1) Reach out to one person you trust, even just to say "I'm struggling"\n2) Take one small step toward self-care - a walk, a meal, rest\n3) Contact a crisis counselor who can provide immediate support\n\nResources available 24/7:\nNational Suicide Prevention Lifeline (US): 988\nCrisis Text Line: Text HOME to 741741\nInternational: findahelpline.com\n\nOne year from now, you will be grateful you reached out today. Your story is still being written.`
